...
//----------------------------------------------------------------------
//
// Procedure:       KbdResetEx
//
// Description:     Resets the input device hardware. This routine is a part
//                  of SimpleTextInEx protocol implementation.
//
// Parameters:      EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL
...
//
// Paremeters:      KEY_WAITING_RECORD - *Ps2KeyIn
//
    ...
    KEYBOARD*   Kbd )
{
    ...
    if (bIndicators != Kbd->Indicators && Kbd->ScannerState == KBST_READY) {
        //
        // Issue Keyboard LED Command 0xED
        //
        CheckIssueLEDCmd(Kbd);
