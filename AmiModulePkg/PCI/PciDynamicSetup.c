...
//----------------------------	
    if (gPciDevForm.Pcie1StartOpCodeHandle != NULL)
    {
        ...
        //HiiFreeOpCodeHandle (gPciDevForm.MaxReadReqOpCodeHandle);    //AptioV server override: MaxReadRequest is readonly for this chipset. 
        //HiiFreeOpCodeHandle (gPciDevForm.AspmModeOpCodeHandle);      //AptioV server override: IntelRCSetup has ASPM Setup option for each Root ports.IntelRcSetup Question will be used.   
    ...
    //AptioV server override start: MaxReadRequest is readonly for this chipset. 
    ...
    //AptioV server override end: MaxReadRequest is readonly for this chipset. 
    ...
    HiiCreateSubTitleOpCode(gPciDevForm.Pcie1StartOpCodeHandle,
    		...
    		STRING_TOKEN(STR_EMPTY),
            0,0);
    //AptioV server override start: IntelRCSetup has ASPM Setup option for each Root ports.IntelRcSetup Question will be used.        
    ...
    //AptioV server override end: IntelRCSetup has ASPM Setup option for each Root ports.IntelRcSetup Question will be used.    
...
)
{
    ...
    EFI_STRING			s=NULL;
    EFI_VARSTORE_ID		vsid;
    BOOLEAN				pcie1=FALSE, pcie2=FALSE, hp=FALSE, ari=FALSE; 
//    VOID				*defopt=NULL;
//--------------------------------------------
//EFI_DEADLOOP();    
