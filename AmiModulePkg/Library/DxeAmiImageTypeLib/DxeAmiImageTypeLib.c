...
/**
  ...
  The function calls LocateDevicePath to find the closes handle that supports the protocol
...
VOID* AmiImageTypeLibLocateInterface(
	...
	if (EFI_ERROR(gBS->LocateDevicePath(ProtocolGuid, &DevicePath, &Handle)))
		return NULL;
