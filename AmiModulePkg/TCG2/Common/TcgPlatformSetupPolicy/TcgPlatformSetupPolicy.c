...

{
  ...
  NewTcgPlatformSetupInstance->ConfigFlags.TcmSupportEnabled        = StatusFlags->TcmSupportEnabled ;
  ...
  NewTcgPlatformSetupInstance->ConfigFlags.PcrBanks               = StatusFlags->PcrBanks;
  ...
  if(UpdateNvram){
       ...
       SetupDataBuffer.TcmSupportEnabled    =   NewTcgPlatformSetupInstance->ConfigFlags.TcmSupportEnabled;
       ...
       SetupDataBuffer.Sha1 = NewTcgPlatformSetupInstance->ConfigFlags.PcrBanks & 1;
       SetupDataBuffer.Sha256 = NewTcgPlatformSetupInstance->ConfigFlags.PcrBanks & 2;
       SetupDataBuffer.Sha384 = NewTcgPlatformSetupInstance->ConfigFlags.PcrBanks & 4;
       SetupDataBuffer.Sha512 = NewTcgPlatformSetupInstance->ConfigFlags.PcrBanks & 8;
       SetupDataBuffer.SM3 = ((NewTcgPlatformSetupInstance->ConfigFlags.PcrBanks & 10)>>4);
