...
//          and are used globally witching EHCI-specific code
//----------------------------------------------------------------------------
...
typedef struct _EHCI_USBSTS
{
    union {
        UINT32  AllBits;
            ...
            #define EHCI_FRAME_LIST_ROLLOVER    BIT3    // Frame List Roll over
...
typedef struct _EHCI_USBINTR
{
    union {
        UINT32  AllBits;
            ...
            #define EHCI_FLRINT_EN      BIT3    // Frame List Roll over Interrupt Enable
