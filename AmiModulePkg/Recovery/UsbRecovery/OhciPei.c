...
/**
    ...
    @param PeiServices --  PEI Sevices table pointer
...
UINT32
OhciGetOperationalRegisterBase (
    IN  EFI_PEI_SERVICES    **PeiServices,
...
/**
    ...
    @param OhciDevPtr  --  This is a pointer to a PEI_OHCI_DEV structure
...
/**
    All leading whitespace on this line is removed by Help builder
    Description of this function can be block aligned in this section.
    The first tab that Help builder will recognize will be at tab stop 21,
    which will indent 4 spaces in Help builder.

    This text is indented 4 spaces in Help builder

    @param PeiServices --  EFI_PEI_SERVICES pointer
    @param OhciDevPtr --  PEI_OHCI_DEV pointer
...
)
{
    ...
    OhciHcReg->HcRhDescriptorB.AllBits =
        (ALL_REMOVEABLE |               // All devices are removable
...
)
{
    ...
    //Do USBRESET to reset root hub and downstream port
...
/**
    This routine resets the Host Controller 

    @param PeiServices,
    @param This
    @param Attributes

    @retval Successfully reset controller.
...
)
{
    ...
    *(UINT32 *) fpData = (UINT32) DataBuffer;
    ...
    //  do not need re-binding to the EDControl.
    //
    ...
    if (*DataLength) {  // some data to transfer
        ...
        //   TDs do not need re-binding to the EDControl.
        // The CSReloadValue field will contain 0 because this is a
        //   "one shot" packet.
        // The pCallback will be set to point to the OHCI_ControlTDCallback
        //   routine.
...
/**
    This function waits for a transfer to complete by polling the 
