...
)
{
    ...
    // All devicse added after the master device are only used to update the modes table
    else
    ...
    // If this was the first device, then call set mode and enable the cursoor based on the 
