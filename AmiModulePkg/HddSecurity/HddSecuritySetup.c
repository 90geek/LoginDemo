...
/**
    This function initializes the HddSecurity setup option values
...
)
{
    ...
    gHddSecurityConfig->Count = gHddSecurityCount;
    ...
    for(i = 0; i<gHddSecurityCount; i++) {
        ...
        InitString(HiiHandle, gHddSecurityName[i], L"%s", Name);
    }
...
)
{
    ...
    for( HardDiskNumber = 0 ; HardDiskNumber < gHddSecurityConfig->Count ; HardDiskNumber++ )
    {
