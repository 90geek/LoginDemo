...
#if USB_GROUP == 2
#if	USBFDD_GROUP_SUPPORT	//TH0047B
...
#if	USBKEY_GROUP_SUPPORT	//TH0047B
...
#endif	//TH0047B
#if	USBLAN_GROUP_SUPPORT	//TH0047B
...
#endif
//TH0008A            if (IsShellBootOption(Option)) BaseTag = BoTagEmbeddedShell;
//TH0008A            else BaseTag = BoTagUefi;
        BaseTag = BoTagUefi;//TH0008A
...
#if	USBFDD_GROUP_SUPPORT	//TH0047A
    //(EIP96232+)>
