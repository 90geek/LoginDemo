...
VOID ApplyIpmiBootRequest(){
    ...
    switch(gUefiBoot){
        ...
        case 1: // Uefi Boot
            switch(gIpmiForceBootDevice){
                ...
                case ForceBootHardDrive: TargetType = BoTagUefiHardDisk; break;
                //case ForceBootHardDriveSafeMode: TargetType = 0; break;
                //case ForceBootDiagnosticPartition: TargetType = 0; break;
    ...
    if(gPersistentBoot){   // gPersistentBoot == '1'
        ...
        //
#if !defined(IPMI_BOOT_DONOT_USE_BOOTNEXT) || (IPMI_BOOT_DONOT_USE_BOOTNEXT == 0)  //TH0144        
        if(Option = SearchBootOptionInBootOptionListByType(TargetType)){
            IsFound = TRUE;
        }
...
#endif // !defined(IPMI_BOOT_DONOT_USE_BOOTNEXT) || (IPMI_BOOT_DONOT_USE_BOOTNEXT == 0) //TH0144
    } // if(gPersistentBoot){
...
)
{
    ...
    //TH0144>>>   
#if defined(IPMI_BOOT_DONOT_USE_BOOTNEXT) && (IPMI_BOOT_DONOT_USE_BOOTNEXT == 1)   
    return;   
#endif //defined(IPMI_BOOT_DONOT_USE_BOOTNEXT) && (IPMI_BOOT_DONOT_USE_BOOTNEXT == 1)   
//TH0144<<< 
