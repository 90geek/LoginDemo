  ...
  )
{
  ...
  IsIdStr = (CHAR16 *) String;
   ...
   if (StrLen (IsIdStr) != 6) {
    ...
    //
       CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_ISID),NULL);
    UnicodeSPrint (
      PortString,
  ...
  )
{
  ...
  CharPtr = HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INITIATOR_IP),NULL);
  //
  // AMI Porting End - Display initiator IP when DHCP is enabled
  //
...
//  EFI_INPUT_KEY               Key;                    // AMI PORTING.
  ...
  if (IfrNvData->Enabled != ISCSI_DISABLED) {
    if (Attempt->SessionConfigData.ConnectTimeout < CONNECT_MIN_TIMEOUT) {
	  ...
	  //
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
        CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_CONNECT_MIN_TIMEOUT),NULL);
        AMICreatePopUp (CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
    ...
    if (!Attempt->SessionConfigData.InitiatorInfoFromDhcp) {
      ...
      if ((Gateway.Addr[0] != 0)) {
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
        CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_GATEWAY_SET_SUBNETMASK_ZERO),NULL);
        AMICreatePopUp (CharPtr);	
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_IP_GATEWAY_IN_DIFF_SUBNET),NULL);
          AMICreatePopUp(CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
    ...
    if (!Attempt->SessionConfigData.TargetInfoFromDhcp && Attempt->SessionConfigData.IpMode < IP_MODE_AUTOCONFIG) {
      if (!IpIsUnicast (&Attempt->SessionConfigData.TargetIp, IfrNvData->IpMode)) {
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_TARGET_IP),NULL);
          AMICreatePopUp(CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
      ...
      if (Attempt->SessionConfigData.TargetName[0] == '\0') {
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
        CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_TARGETNAME),NULL);
        AMICreatePopUp(CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
    ...
    if (IfrNvData->AuthenticationType == ISCSI_AUTH_TYPE_CHAP) {
      if ((IfrNvData->CHAPName[0] == '\0') || (IfrNvData->CHAPSecret[0] == '\0')) {
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_CHAP_NAME),NULL);
          AMICreatePopUp(CharPtr);	      
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
      ...
      if ((IfrNvData->CHAPType == ISCSI_CHAP_MUTUAL) &&
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
         CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_REVERSE_CHAP_NAME),NULL);
         AMICreatePopUp(CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
    ...
    if (SameNicAttempt != NULL) {
      ...
      //  AMI PORTING START - To give Multilanguage Support.
      //
        CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_ATTEMPTS_SAME_NIC),NULL);
        UnicodeSPrint (
        mPrivate->PortString,
        (UINTN) ISCSI_NAME_IFR_MAX_SIZE,
        CharPtr,
  ...
  if (IfrNvData->Enabled == ISCSI_DISABLED) {
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_ISCSI_MODE_DISABLED),NULL);
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_ISCSI_MODE_ENABLED),NULL);
          UnicodeSPrint(IScsiMode, 64, CharPtr);
         //
        //  AMI PORTING END - To give Multilanguage Support.
        //
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_ISCSI_MODE_ENABLED_FOR_MPIO),NULL);
          UnicodeSPrint(IScsiMode, 64, CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
  ...
  if (IfrNvData->IpMode == IP_MODE_IP4) {
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_IP_MODE_IP4),NULL);
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_IP_MODE_IP6),NULL);
          UnicodeSPrint(IpMode, 64, CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_IP_MODE_AUTOCONFIG),NULL);
          UnicodeSPrint(IpMode, 64, CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
  ...
  //  AMI PORTING START - To give Multilanguage Support.
  //
  CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_PFA_MODE_IPVER),NULL);
  UnicodeSPrint (
    mPrivate->PortString,
    (UINTN) ISCSI_NAME_IFR_MAX_SIZE,
    CharPtr,
  ...
  )
{
  ...
  //  AMI PORTING START - To give Multilanguage Support.
  //
    CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_MAC),NULL);
  ...
  //  AMI PORTING START - To give Multilanguage Support.
  //
    CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_PFA),NULL);
    UnicodeSPrint (
      mPrivate->PortString,
      (UINTN) ISCSI_NAME_IFR_MAX_SIZE,
      CharPtr,
  ...
  )
{
  ...
  //  AMI PORTING START - To give Multilanguage Support.
  //
    CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_ATTEMPT),NULL);
  ...
  )
{
  ...
  //
    ...
    //  AMI PORTING START - To give Multilanguage Support.
    //
    CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_MAC_INFO),NULL);
    UnicodeSPrint (
      mPrivate->PortString,
      (UINTN) ISCSI_NAME_IFR_MAX_SIZE,
      CharPtr,
  ...
  )
{
  ...
  *Progress = Request;
  ...
  //  AMI PORTING START - To give Multilanguage Support.
  //
    CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_OFFSET_WIDTH ),NULL);
  ...
  )
{
  ...
  if (Action == EFI_BROWSER_ACTION_CHANGING) {
    ...
    default:
      ...
      if ( ( (StrLen (IfrNvData->CHAPSecret) >= ISCSI_CHAP_SECRET_MIN_LEN) && \
         ...
         //  AMI PORTING START - To give Multilanguage Support.
         //
         CharPtr=HiiGetString(Private->RegisteredHandle,STRING_TOKEN(STR_CHAP_STATUS_INSTALLED),NULL);
         ...
         //  AMI PORTING START - To give Multilanguage Support.
         //
        CharPtr=HiiGetString(Private->RegisteredHandle,STRING_TOKEN(STR_CHAP_STATUS_NOT_INSTALLED),NULL);
        HiiSetString( Private->RegisteredHandle, STR_ISCSI_CHAP_STATUS, CharPtr , NULL);
         //
         //  AMI PORTING END - To give Multilanguage Support.
         //
  ...
  //  AMI PORTING START - To give Multilanguage Support.
  //
  CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_ISCSI_NAME),NULL);
  AMICreatePopUp(CharPtr);
  //
  //  AMI PORTING END - To give Multilanguage Support.
  //
    ...
    case KEY_LOCAL_IP:
      ...
      if ( EFI_ERROR (Status) ) {
         ...
         //  AMI PORTING START - To give Multilanguage Support.
         //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_IP_ADDRESS),NULL);
          AMICreatePopUp(CharPtr);
         //
         //  AMI PORTING END - To give Multilanguage Support.
         //
    ...
    case KEY_SUBNET_MASK:
      ...
      if ( EFI_ERROR (Status) ) {
          ...
          //  AMI PORTING START - To give Multilanguage Support.
          //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_SUBNETMASK),NULL);
          AMICreatePopUp(CharPtr);
          //
          //  AMI PORTING END - To give Multilanguage Support.
          //
    ...
    case KEY_GATE_WAY:
      ...
      if ( EFI_ERROR (Status) ) {
          ...
          //  AMI PORTING START - To give Multilanguage Support.
          //
          CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_GATEWAY),NULL);
          AMICreatePopUp(CharPtr);
          //
          //  AMI PORTING END - To give Multilanguage Support.
          //
    ...
    case KEY_BOOT_LUN:
      ...
      if (EFI_ERROR (Status)) {
        ...
        //  AMI PORTING START - To give Multilanguage Support.
        //
        CharPtr=HiiGetString(mCallbackInfo->RegisteredHandle,STRING_TOKEN(STR_INVALID_LUN),NULL);
        AMICreatePopUp (CharPtr);
        //
        //  AMI PORTING END - To give Multilanguage Support.
        //
