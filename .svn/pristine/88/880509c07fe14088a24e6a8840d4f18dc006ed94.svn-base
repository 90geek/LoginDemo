...
#ifndef _EFI_SMBIOS_ELOG_SUPPORT_H_
#define _EFI_SMBIOS_ELOG_SUPPORT_H_

#define EFI_SMBIOS_ELOG_SUPPORT_GUID { \
  0x0e5870e4, 0x0525, 0x40ad, 0x95, 0xa8, 0x0f, 0xff, 0x15, 0x5b, 0x8f, 0xc0 }

EFI_GUID gEfiSmbiosElogSupportGuid;

typedef struct _EFI_SMBIOS_ELOG_SUPPORT_PROTOCOL
    EFI_SMBIOS_ELOG_SUPPORT_PROTOCOL;
...
//TH0053>>>
#define EFI_EVENT_LOG_TYPE_OEM_IDE_DEVICE_FAIL              0x80
#define EFI_EVENT_LOG_TYPE_OEM_FLASH_UPDATE_FAILED          0x81
#define EFI_EVENT_LOG_TYPE_PCI_BUS_OUT_OF_RESOURCES         0x82
#define EFI_EVENT_LOG_TYPE_LEGACY_OPROM_NO_SPACE            0x83
#define EFI_EVENT_LOG_TYPE_PASSWORD_INVALIDED               0x84
//TH0053<<<
#define EFI_EVENT_LOG_TYPE_CLEAR_CMOS						            0x85 //TH0095
