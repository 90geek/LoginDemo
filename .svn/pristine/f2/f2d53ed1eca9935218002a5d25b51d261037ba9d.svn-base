...
//
// Description: Handle commands sent from KBC to PS2 Mouse. Mouse idle, 
...
//
// Description: Mouse Input source sends data. Put the data into the buffer, 
//              attempt to send the first byte. The call comes outside of 
//              trapping Leg access. 
//              Check that Trapping status will not be overriden
//
// Input:       This - pointer to the Emulation Protocol
//              Data - Ps2 mouse Data
//
// Output:      None
//
...
//
// Description: KBC has empty queue; Legacy I/O trapping is being processed.
...
//
// Description: Clear the mouse data buffer that tracks the mouse changes; 
