  ...
  VOID )
{
    ...
    SERVER_IPMI_DEBUG ((EFI_D_LOAD, "DxeIpmiInterfaceLib: gEfiDxeIpmiUsbTransportProtocolGuid Status: %r \n", Status));
}
  ...
  VOID )
{
    ...
    Status = gBS->LocateProtocol (
                ...
                NULL,
                (VOID **)&gIpmiTransport );
    SERVER_IPMI_DEBUG ((EFI_D_LOAD, "DxeIpmiInterfaceLib: gEfiDxeIpmiTransportProtocolGuid Status: %r \n", Status));
}
  ...
  IN EFI_SYSTEM_TABLE  *SystemTable )
{
    ...
    //
    LocateIpmiProtocol ();
    SERVER_IPMI_DEBUG ((EFI_D_LOAD, "DxeIpmiInterfaceLib: gIpmiTransport: %X \n", gIpmiTransport));

    //
    // Locate the IPMI USB transport protocol.
    //
    LocateIpmiUsbProtocol ();
    SERVER_IPMI_DEBUG ((EFI_D_LOAD, "DxeIpmiInterfaceLib: gIpmiUsbTransport: %X \n", gIpmiUsbTransport));
