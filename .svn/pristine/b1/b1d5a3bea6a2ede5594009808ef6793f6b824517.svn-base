...
VOID HandleGA20Sequence()
{
    ...
    // Legacy Free system. Handle it using PORT 92. Right now the GA20 enabled
    // using Port 92h. Incase KBC is present, we need to do it using port 60/64.
    // Most of the chipset support port 92h for enabling the GA20. If any chipset
    // doesn't support, this code needs to be changed accordngly.
    Data = GetHceInput();
