  ...
  )
{
  ...
  EFI_GUID                  *IpServiceBindingGuid;                     //  AMI PORTING  : Adding common guid for Ip.

  if (IpVersion == IP_VERSION_4) {
    IScsiServiceBindingGuid  = &gIScsiV4PrivateGuid;
    TcpServiceBindingGuid    = &gEfiTcp4ServiceBindingProtocolGuid;
    DhcpServiceBindingGuid   = &gEfiDhcp4ServiceBindingProtocolGuid;
    IpServiceBindingGuid     = &gEfiIp4ServiceBindingProtocolGuid;     //  AMI PORTING  : Adding common guid for Ip.
  } else {
    IScsiServiceBindingGuid  = &gIScsiV6PrivateGuid;
    TcpServiceBindingGuid    = &gEfiTcp6ServiceBindingProtocolGuid;
    DhcpServiceBindingGuid   = &gEfiDhcp6ServiceBindingProtocolGuid;
    IpServiceBindingGuid     = &gEfiIp6ServiceBindingProtocolGuid;    //  AMI PORTING  : Adding common guid for Ip.
  }
  ...
  //
  // Return EFI_ALREADY_STARTED if the driver is already started.
  //
  if (!EFI_ERROR (Status)) {
  ...
  if (!EFI_ERROR (Status)) {
    // Get Other protocols that we need to wait for
    IScsiUpdateDHCPInfo(ControllerHandle);
  ...
  // AMI PORTING START.
  //
  if ((gWaitforIp4 == TRUE) || (gWaitforIp6 == TRUE)) { // Wait for Ip4 driver or Ip6 Driver.
         Status = gBS->OpenProtocol (
                        ControllerHandle,
...
//     DEBUG ((EFI_D_ERROR, "Wait for Ip4 = %r , Wait for Tcp4 = %r .\n",DhcpStatus,Status ));
