...
#if defined(SECURITY_SETUP_ON_SAME_PAGE) && SECURITY_SETUP_ON_SAME_PAGE
    for(HddIndex = 0; HddIndex < gHddSecurityCount && HddIndex < HDD_SECURITY_MAX_HDD_COUNT; HddIndex++) {
...
/**
    This function initializes the HDD Security IFR contents.
...
/**
    This function initializes the HDD Security HiiHandle and register protocol 
    callback to initialize IFR contents during setup entry.
...
**/
VOID
InitHddSecurityDynamicSetupStrings (
    EFI_HII_HANDLE  HiiHandle,
    UINT16          Class
)
{
    static VOID *SetupRegistration;
    ...
    RegisterProtocolCallback(
        &SetupEnterGuid, InitHddSecurityDynamicIfrContents,
