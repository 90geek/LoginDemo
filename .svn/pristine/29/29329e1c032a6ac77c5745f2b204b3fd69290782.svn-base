  ...
  )
{
  switch (Char) {
    ...
    case 0x000C:
//*** AMI PORTING BEGIN ***//
//  \n was not viewed as a possible line break character, which meant the 
//  StringToImage function would treat it as a printable character and 
//  output a glyph for it. USWG approved adding 0x000A as a line break 
//  a valid line break character
    case 0x000A:
//*** AMI PORTING END ***//
    case 0x000D:
    case 0x2028:
