  ...
  IN EFI_SYSTEM_TABLE       *SystemTable )
{
  ...
  EFI_SMBIOS_ELOG_SUPPORT_PROTOCOL    *SmbiosProtocol = NULL;
...
// this SMM version can not run.
  ...
  Status = gBS->LocateProtocol (&gEfiSmbiosElogSupportGuid, NULL, (VOID **)&SmbiosProtocol);
...
// Register SMM DxeSmmRedirFuncsHandler SMI handler
      ...
      NewHandle = NULL;
      Status = gSmst->SmiHandlerRegister (DxeSmmRedirFuncsHandler, &gSmmDummyProtocolRedirGuid, &NewHandle);
      ASSERT_EFI_ERROR (Status);
