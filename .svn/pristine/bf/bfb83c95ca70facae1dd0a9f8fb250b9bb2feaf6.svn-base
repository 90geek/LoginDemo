...
//TH0179>>>
    	//
		//Log:Unrecoverable hard dik/ATAPI/IDE device failure into SEL(IDE mode).  
		//
...
//TH0179>>>  
#if OEM_SEL_LOG_SUPPORT 
    	Status = GetIdentifyData( IdeBusInterface, &(IdeBusInterface->IdeDevice));
        //
		//Log:Unrecoverable hard disk controller failure into SEL(IDE mode). 
		//
    	if(EFI_ERROR( Status )){
