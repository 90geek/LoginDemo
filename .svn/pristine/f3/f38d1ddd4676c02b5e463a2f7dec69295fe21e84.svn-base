...
// Name: mouse.c
//
// Description: This is the PS/2 mouse EFI driver source file. It has 
//              PS/2 mouse I/O support fuctions.
//
//----------------------------------------------------------------------
//<AMI_FHDR_END>
    ...
    EFI_SIMPLE_POINTER_STATE *state)
{
    ...
    if(MsIrqSupport && gMouseIrqInstall && PendingMouseData.DataValid){
