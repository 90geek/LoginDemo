...
if NOT "%~4" == "" %WORKSPACE%\%1\Tools\FlashImageTool\spsFITC.exe /s %WORKSPACE%\%1 /b /bios %WORKSPACE%\%OUTPUT_DIR%\FV\AMIROM.fd /der %WORKSPACE%\%1\PTU\Grantley_SpsNMPTU_signed.rom %WORKSPACE%\%2\%4.xml /o %WORKSPACE%\%OUTPUT_DIR%\ROM\OutImage_NM.bin
