...
/** @file IpmiNetFnStorageDefinitions.h
    Definitions required for Storage commands.
...
Abstract:
  The file has all the definitions required for Storage commands
--*/
...
//TH0170 #define BIOS_SOFTWARE_ID                          0x00
//TH0170 #define SMI_HANDLER_SOFTWARE_ID                   0x10
//TH0170>>>
#define BIOS_SOFTWARE_ID                          0x01 
#define SMI_HANDLER_SOFTWARE_ID                   0x19
//TH0170<<<
//TH0171>>>
/* TH0171A
...
typedef struct {
  ...
  EFI_SEL_RECORD_DATA RecordData; ///< SEL Record Data
