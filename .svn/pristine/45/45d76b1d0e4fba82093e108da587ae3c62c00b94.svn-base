...
#include <Library/DebugPrintErrorLevelLib.h> // AptioV Server override : Fix for the Debug Messages not getting printed in SMM
#include <Library/BaseLib.h>
#include <Protocol/AmiDebugService.h> // AptioV Server override : Fix for the Debug Messages not getting printed in SMM
  ...
  )
{
    ...
    if(AmiDebugServiceProtocol == NULL || (ErrorLevel & GetDebugPrintErrorLevel ()) == 0) return; // AptioV Server override : Fix for the Debug Messages not getting printed in SMM
