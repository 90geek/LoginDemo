...
// #if defined(FtRecovery_SUPPORT) && (FtRecovery_SUPPORT == 1)  // AptioV Server Override - To avoid Build Error on disabling FtRecovery_SUPPORT
// Top swap support
...
// ---------------
// #endif  // AptioV Server Override - To avoid Build Error on disabling FtRecovery_SUPPORT
