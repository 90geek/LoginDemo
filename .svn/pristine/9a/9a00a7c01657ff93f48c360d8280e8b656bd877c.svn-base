...
{
  //TH0134  if (Time->Year < 1900 || // AptioV Server Override: Year value range changed as per UEFI Spec 2.3.1
  if (Time->Year < 2005 ||	//TH0134
      Time->Year > 9999 || // AptioV Server Override: Year value range changed as per UEFI Spec 2.3.1
      Time->Month < 1 ||
      Time->Month > 12 ||
      (!DayValid (Time)) ||
      Time->Hour > 23 ||
