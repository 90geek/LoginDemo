...
//TH0025>>>
#define OEM_PASSWORD_JUMPER_GUID \
 {0xd4ab32b3, 0xb33e, 0x4af7, 0xc0, 0x73, 0x60, 0xea, 0x4b, 0x16, 0x19, 0xaf}

typedef struct
{
    EFI_HOB_GUID_TYPE	EfiHobGuidType;
    UINT8				ClearPassword;
} OEM_PASSWORD_JUMPER_HOB;
//TH0025<<<

//TH0089>>>>
#if  Thor_SUPPORT == 1
// {D7B1F2F6-54BF-49c3-BE9D-6303197A0913}
#define OEM_BOARD_SKU_GUID \
 {0xd7b1f2f6, 0x54bf, 0x49c3, 0xbe, 0x9d, 0x63, 0x3, 0x19, 0x7a, 0x9, 0x13}

typedef struct
{
    EFI_HOB_GUID_TYPE	EfiHobGuidType;
    UINT8				OnBoardI350PortCount;
    BOOLEAN				LanOcpCardPresent;	//TH0118
} OEM_BOARD_SKU_HOB;
#endif
//TH0089<<<<
                                        // (P090109B)>
