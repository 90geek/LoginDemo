...
#include "SysFunc.h"
#include <Token.h> //AptioV server override: Use SDL token for PM base address.
            ...
            )
{
  ...
  //
    ...
    host->var.common.pmBase = PM_BASE_ADDRESS; //AptioV server override: Use SDL token for PM base address.
#ifdef PCH_SPT
    WritePciCfg (
                host,
                0,
