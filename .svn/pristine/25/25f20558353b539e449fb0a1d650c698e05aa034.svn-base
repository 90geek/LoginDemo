...
// Porting Steps:
//
// 1)  define/undefined the appropriate SouthBridge type
...
/**
    ...
    @param Pci --  EFI_PEI_PCI_CFG2_PPI pointer
    @param StallPpi --  EFI_PEI_STALL_PPI pointer
    ...
    EFI_PEI_STALL_PPI           *StallPpi )
{
    ...
    //
    // OHCI is sits behind the PCI bridge. So program the PCI bridge
