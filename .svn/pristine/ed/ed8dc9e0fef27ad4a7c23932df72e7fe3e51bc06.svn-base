...
#if defined AMT_SUPPORT && AMT_SUPPORT == 1  //AptioV server override
...
//TH0174>>>
    UINT8   		Length;
    UINT16       	Handle;
    UINT16			HandleBuffer[NUMBER_OF_SYSTEM_SLOTS];
    UINT32			Gp_Lvl2_Temp, Gp_Lvl3_Temp;
    UINT8 Count1 = 1;
    UINT8 Count2 = 1;
...
//TH0174>>>
            	Length = ((SMBIOS_STRUCTURE_HEADER*)StructureFoundPtr)->Length;
            	HandleBuffer[i] = ((SMBIOS_STRUCTURE_HEADER*)StructureFoundPtr)->Handle;
/*ZYY006001-START            	
            	//Slot1 (PCIe_x20_CPU0) x20
            	if ((Gp_Lvl3_Temp & BIT7) && (Gp_Lvl2_Temp & BIT2)) { // N/A
					if(!MemCmp(StructureFoundPtr + Length, "Slot1 (PCIe_x20_CPU0) x16", Strlen("Slot1 (PCIe_x20_CPU0) x16")) || 
							!MemCmp(StructureFoundPtr + Length, "Slot1 (PCIe_x20_CPU0) x4", Strlen("Slot1 (PCIe_x20_CPU0) x4"))){
						HandleBuffer[i] = 0;
					}
            	}else if (!(Gp_Lvl3_Temp & BIT7) && (Gp_Lvl2_Temp & BIT2)) { // 2U2 Riser x8 + x8
					if(!MemCmp(StructureFoundPtr + Length, "Slot1 (x8x8)Riser1 x8", Strlen("Slot1 (x8x8)Riser1 x8")) || 
							!MemCmp(StructureFoundPtr + Length, "Slot1 (x8x8)Riser2 x8", Strlen("Slot1 (x8x8)Riser2 x8")))
						HandleBuffer[i] = 0;
            	}else if (!(Gp_Lvl3_Temp & BIT7) && !(Gp_Lvl2_Temp & BIT2)) { // 2U2 Riser x8 + x16
					if(!MemCmp(StructureFoundPtr + Length, "Slot1 (x8x16)Riser1 x4", Strlen("Slot1 (x8x16)Riser1 x4")) || 
							!MemCmp(StructureFoundPtr + Length, "Slot1 (x8x16)Riser2 x16", Strlen("Slot1 (x8x16)Riser2 x16")))
						HandleBuffer[i] = 0;
            	}else if ((Gp_Lvl3_Temp & BIT7) && !(Gp_Lvl2_Temp & BIT2)) { // 1U1 Riser x16
					if(!MemCmp(StructureFoundPtr + Length, "Slot1 Riser x16", Strlen("Slot1 Riser x16")))
						HandleBuffer[i] = 0;
            	}
            	
            	//Slot2 (PCIe_x24_CPU1) x24
            	if ((Gp_Lvl3_Temp & BIT1) && (Gp_Lvl3_Temp & BIT2)) { // N/A
					if(!MemCmp(StructureFoundPtr + Length, "Slot2 (PCIe_x24_CPU1) x16", Strlen("Slot2 (PCIe_x24_CPU1) x16")) || 
							!MemCmp(StructureFoundPtr + Length, "Slot2 (PCIe_x24_CPU1) x8", Strlen("Slot2 (PCIe_x24_CPU1) x8"))){
						HandleBuffer[i] = 0;
					}
            	}else if (!(Gp_Lvl3_Temp & BIT1) && (Gp_Lvl3_Temp & BIT2)) { //2U2 Riser x8 + x8
					if(!MemCmp(StructureFoundPtr + Length, "Slot2 (x8x8)Riser1 x8", Strlen("Slot2 (x8x8)Riser1 x8")) || 
							!MemCmp(StructureFoundPtr + Length, "Slot2 (x8x8)Riser2 x8", Strlen("Slot2 (x8x8)Riser2 x8")))
						HandleBuffer[i] = 0;
            	}else if (!(Gp_Lvl3_Temp & BIT1) && !(Gp_Lvl3_Temp & BIT2)) { //2U2 Riser x8 + x16
					if(!MemCmp(StructureFoundPtr + Length, "Slot2 (x8x16)Riser1 x8", Strlen("Slot2 (x8x16)Riser1 x8")) || 
							!MemCmp(StructureFoundPtr + Length, "Slot2 (x8x16)Riser2 x16", Strlen("Slot2 (x8x16)Riser2 x16")))
						HandleBuffer[i] = 0;
            	}else if ((Gp_Lvl3_Temp & BIT1) && !(Gp_Lvl3_Temp & BIT2)) { //1U1 Riser x16
					if(!MemCmp(StructureFoundPtr + Length, "Slot2 Riser x16", Strlen("Slot2 Riser x16")))
						HandleBuffer[i] = 0;
            	}
...
ZYY006001-END */
                ...
                //ZYY006001- ((SMBIOS_SYSTEM_SLOTS_INFO*)StructureFoundPtr)->BusNumber = ((SYSTEM_SLOT_DYNAMIC_DATA*)SmbiosVariableBuffer)->BusNumber[i];
                ((SMBIOS_SYSTEM_SLOTS_INFO*)StructureFoundPtr)->BusNumber = ((SYSTEM_SLOT_DYNAMIC_DATA*)SmbiosVariableBuffer)->BusNumber[i];//ZYY006002+
                ((SMBIOS_SYSTEM_SLOTS_INFO*)StructureFoundPtr)->DevFuncNumber = ((SYSTEM_SLOT_DYNAMIC_DATA*)SmbiosVariableBuffer)->DevFuncNumber[i];//ZYY006002+
                ((SMBIOS_SYSTEM_SLOTS_INFO*)StructureFoundPtr)->SegGroupNumber = ((SYSTEM_SLOT_DYNAMIC_DATA*)SmbiosVariableBuffer)->SegGroupNumber[i];//ZYY006006+
            }
        }
//TH0174>>>
        for (i = 0; i < gSmbiosBoardProtocol->NumberOfSystemSlots; i++){
        	Handle = HandleBuffer[i];
        	//ZYY006001- if(Handle != 0)
        	//ZYY006002- if(((SYSTEM_SLOT_DYNAMIC_DATA*)SmbiosVariableBuffer)->CurrentUsage[i] == 0x02){   //ZYY006001+
        	//ZYY006006- if(((SYSTEM_SLOT_DYNAMIC_DATA*)SmbiosVariableBuffer)->CurrentUsage[i] != 0x04){   //ZYY006002+
        	if(((SYSTEM_SLOT_DYNAMIC_DATA*)SmbiosVariableBuffer)->CurrentUsage[i] == 0x02){   //ZYY006006+
        		DeleteStructureByHandle(Handle); //Delete the structure by handle
        	}//ZYY006001+
        }
//TH0174<<<
    }
...
)
{
    ...
    if (MemType == 0) return EFI_UNSUPPORTED;       // Not supported
    if (MemType == 1) SpdOffset = 64;               // DDR2
    if (MemType == 2) SpdOffset = 117;              // DDR3
    if (MemType == 3) SpdOffset = 320;              // DDR4
    ...
    if (MemType == 3) {                             // DDR4
        i = Data8 & 0x7f;                           // Remove parity bit
        if (SpdData) {
            Data8 = SpdData->Byte320To321[322 - 320];
        }
        else {
    ...
    i = 0;
    do {
        // If new string is longer than original string, exit at end of original string
        if (*StructBuffer == 0) return EFI_BUFFER_TOO_SMALL;    // Truncate if string is too long
        *StructBuffer++ = FilterCharacter(IdTblPtr->ManufacturerString[i]);
        i++;
    } while (IdTblPtr->ManufacturerString[i] != 0);

    // New string is shorter, fill the remainder with spaces
    while (*StructBuffer != 0) *StructBuffer++ = 0x20;
...
)
{
    ...
    CHAR8           *BiosVersionPtr = BiosVersionStr;
    UINT8           *StructureFoundPtr;

    Sprintf(BiosVersionPtr,
            "%s.%s",
    ...
    if (FindStructureType(&Buffer, &StructureFoundPtr, 0, 1)) {
        ReplaceString(StructureFoundPtr, 2, (UINT8*)BiosVersionPtr);
        return EFI_SUCCESS;
    }
...
{
//(EIP233520_1-)    EFI_STATUS      Status;
//(EIP233520_1-)    EFI_GUID        Smbios2Guid = SMBIOS_TABLE_GUID;
...
//(EIP233520_1-)    Status = pBS->InstallConfigurationTable(&Smbios2Guid, pSmbiosTableEntryPoint);
//(EIP233520_1-)    ASSERT_EFI_ERROR(Status);
...
{
//(EIP233520_1-)    EFI_STATUS      Status;
//(EIP233520_1-)    EFI_GUID        Smbios3Guid = SMBIOS_3_TABLE_GUID;
...
//(EIP233520_1-)    Status = pBS->InstallConfigurationTable(&Smbios3Guid, pSmbiosV3TableEntryPoint);
//(EIP233520_1-)    ASSERT_EFI_ERROR(Status);
