...
#include <Setup.h>
#include <Guid/SetupVariable.h> //AptioV Server override
#include <SB.h> //TH0024
//============================================================================
// GUID Definitions
...
//TH0024>>>
	  ...
	  IsRecovery = !(IoRead32(GPIO_BASE_ADDRESS + ICH_GPIO_GP_LVL3) & BIT6);	//GPIO70
#endif
//TH0024<<<
...
static EFI_GUID mSystemConfigurationGuid = SYSTEM_CONFIGURATION_GUID; //AptioV Server override
//<AMI_PHDR_START>
//----------------------------------------------------------------------------
...
//AptioV Server override Start
    ...
    Size = 0;
    Status=ReadVariablePpi->GetVariable(
        ReadVariablePpi, L"IntelSetup",
        &mSystemConfigurationGuid, NULL,
        &Size, NULL
    );
    if (Status!=EFI_BUFFER_TOO_SMALL) return TRUE;
    return Size==sizeof(SYSTEM_CONFIGURATION);
