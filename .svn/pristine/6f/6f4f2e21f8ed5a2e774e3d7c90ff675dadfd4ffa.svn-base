...
STRING_INIT_FUNC *StringInitFunc[] = { SERSVER_MGMT_STRING_INIT_LIST NULL };
...
**/
SETUP_CALLBACK ServerMgmtCallbackProtocol = {{NULL, NULL, Callback}, SERVER_MGMT_CLASS_ID, 0};
...
CALLBACK_INFO SetupCallBack[] = {
    ...
    { &gEfiServerMgmtSetupVariableGuid, &ServerMgmtCallbackProtocol.Callback, SERVER_MGMT_CLASS_ID, 0, 0}
};
