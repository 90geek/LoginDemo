  ...
  VOID )
{
    ...
    SERVER_IPMI_TRACE ((-1, " IpmiByPassUserPassWord: Entered......\n"));
    ...
    Status = gBS->LocateProtocol (
                 ...
                 NULL,
                 (VOID **)&gIpmiTransport);
    SERVER_IPMI_TRACE((-1, "LocateProtocol gEfiDxeIpmiTransportProtocolGuid. Status: %r\n", Status));
    if ( EFI_ERROR (Status) ) {
    ...
    //
CallOriginalHook:
    SERVER_IPMI_TRACE ((-1, " IpmiByPassUserPassWord: Exiting..... User by pass password bit is not set so calling Original Hook \n"));
