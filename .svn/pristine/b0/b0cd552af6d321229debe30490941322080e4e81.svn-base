...
//AptioV server override start: Do not consider PCI bus setup control for link speed. Use RC selection for link speed.
    ...
    //AptioV server override end: Do not consider PCI bus setup control for link speed. Use RC selection for link speed.
