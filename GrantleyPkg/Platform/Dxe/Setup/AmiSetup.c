...
VOID AmiPowerMgtCallback(IN OUT EFI_IFR_TYPE_VALUE *Value)
{
    ...
    if (SystemConfiguration.CpuPm == 2) {   //If previous was custom.
        ...
        Config.MonitorMwaitEnable = SystemConfiguration.MonitorMwaitEnable; //TH0111
    ...
    if (Value->u8 == 0) {  //Disabled
        ...
        SystemConfiguration.MonitorMwaitEnable = 0; //TH0111
        ...
        SystemConfiguration.MonitorMwaitEnable = 1; //TH0111
        SystemConfiguration.C3Enable = 0;
        ...
        if (EFI_ERROR(Status)) {
     //DJH002033++>>
     #if defined (Generic_SUPPORT) && (Generic_SUPPORT == 1) 
            SystemConfiguration.ProcessorEistEnable = 1;
            SystemConfiguration.TurboMode = 1;
            SystemConfiguration.ProcessorEistPsdFunc = 0;
            SystemConfiguration.BootPState = 0;     //Set to max boot -- Question is suppressed.
            SystemConfiguration.PackageCState = 3;  //C6 retention
            SystemConfiguration.MonitorMwaitEnable = 1;
            SystemConfiguration.C3Enable = 0;
            SystemConfiguration.C6Enable = 1;
            SystemConfiguration.TStateEnable = 1;
    #else  
    //DJH002033++<<
       //LLY011033+>>> 	
            ...
            SystemConfiguration.ProcessorEistEnable = 0;// 1;
            SystemConfiguration.TurboMode =0;//   1;
            SystemConfiguration.ProcessorEistPsdFunc = 0;
            SystemConfiguration.BootPState = 0;     //Set to max boot -- Question is suppressed.
            SystemConfiguration.PackageCState = 0;//  3;  //C6 retention
            SystemConfiguration.MonitorMwaitEnable = 0; //TH0111
            SystemConfiguration.C3Enable = 0;
            SystemConfiguration.C6Enable = 0;//  1;
            SystemConfiguration.TStateEnable = 0;//  1;
       #else
       //LLY011033+ <<<
            SystemConfiguration.ProcessorEistEnable = 1;
            SystemConfiguration.TurboMode = 1;
            ...
            SystemConfiguration.C6Enable = 1;
            SystemConfiguration.TStateEnable = 1;
       #endif //#if defined (Ali_1218_SUPPORT... LLY011033+
    #endif  //#if defined (Generic_SUPPORT) && (Generic_SUPPORT == 1) DJH002033++
        } else {
            ...
            SystemConfiguration.MonitorMwaitEnable = Config.MonitorMwaitEnable; //TH0111
