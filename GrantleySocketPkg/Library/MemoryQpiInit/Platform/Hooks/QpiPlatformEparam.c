...
HSX_ALL_LANES_EPARAM_LINK_INFO  QpiMayanCityAllLanesEparamTable_HSX_B0[] = {
         ...
         //TH0050A>>>
         //Link		TxEQ(Level 3/2/1/0)		Recive Equalization_CTLE
         //C0P0		0x2D 39 33 3F			6
         //C0P1		0x2C 36 35 3F			0
         //C1P0		0x2C 36 35 3F			6
         //C1P1		0x2C 36 35 3F			27
         //TH0050A<<<
   ...
   //Socket 0 **********************************************************************************************************************************************************************************************************************
         {0x0, (1 << PROBE_TYPE_NO_PROBE) | (1 << PROBE_TYPE_COHASSET) | (1 << PROBE_TYPE_VSR), 
               (1 << SPEED_REC_64GT) | (1 << SPEED_REC_72GT) | (1 << SPEED_REC_80GT) | (1 << SPEED_REC_96GT), 
               LINK0, 0x322808, 0x05410102, 0x2D39333F, 0x6},

         {0x0, (1 << PROBE_TYPE_NO_PROBE) | (1 << PROBE_TYPE_COHASSET) | (1 << PROBE_TYPE_VSR), 
               (1 << SPEED_REC_64GT) | (1 << SPEED_REC_72GT) | (1 << SPEED_REC_80GT) | (1 << SPEED_REC_96GT), 
               LINK1, 0x322808, 0x05410102, 0x2C36353F, 0x0},
         
   //Socket 1 **********************************************************************************************************************************************************************************************************************
         {0x1, (1 << PROBE_TYPE_NO_PROBE) | (1 << PROBE_TYPE_COHASSET) | (1 << PROBE_TYPE_VSR), 
               (1 << SPEED_REC_64GT) | (1 << SPEED_REC_72GT) | (1 << SPEED_REC_80GT) | (1 << SPEED_REC_96GT), 
               LINK0, 0x322808, 0x05410102, 0x2C36353F, 0x6},
     
         {0x1, (1 << PROBE_TYPE_NO_PROBE) | (1 << PROBE_TYPE_COHASSET) | (1 << PROBE_TYPE_VSR), 
               (1 << SPEED_REC_64GT) | (1 << SPEED_REC_72GT) | (1 << SPEED_REC_80GT) | (1 << SPEED_REC_96GT), 
               //TH0050A	LINK1, 0x322808, 0x05410102, 0x2C36353F, 0x1E}
               //TH0050B	LINK1, 0x322808, 0x05410102, 0x2C36353F, 27}	//TH0050A
               LINK1, 0x322808, 0x05410102, 0x2C36353F, 24}	//TH0050B
};
