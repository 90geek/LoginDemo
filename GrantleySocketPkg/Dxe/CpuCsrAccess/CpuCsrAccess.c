...
--*/
{
  ...
  if (Flag == 1) {
    ...
    // Get MmcfgLimit
    //
    IoWrite32 (0x0cf8, (0x80000000 | (IioBusNum << 16) |  (5 << 11)  | (0 << 8) | 0x98)); //AptioV server override: Get MMCFG base and limit as per Haswell EP EDS
    ...
    // Get MmcfgBase
    //
    IoWrite32 (0x0cf8, (0x80000000 | (IioBusNum << 16) |  (5 << 11)  | (0 << 8) | 0x90)); //AptioV server override: Get MMCFG base and limit as per Haswell EP EDS 
    MmcfgAddress = IoRead32 (0x0cfc);
    MmcfgAddress &= 0xfc000000;              // Mask Bits[25:0]
  }
  return MmcfgAddress;
