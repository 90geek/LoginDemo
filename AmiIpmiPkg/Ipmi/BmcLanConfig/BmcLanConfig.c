  ...
  IN EFI_SYSTEM_TABLE       *SystemTable )
{
    ...
    SERVER_IPMI_DEBUG ((EFI_D_LOAD, " Entered......... InitializeBmcLanConfig \n"));
    ...
    if ( EFI_ERROR(Status)) {
        BmcLanIp1SetupValues.BmcLan = Unspecified;
#if BMC_LAN_COUNT == 2
        BmcLanIp2SetupValues.BmcLan = Unspecified;
#endif
    } else {
    ...
    gServerMgmtConfiguration.BmcLan1 = Unspecified;
#if BMC_LAN_COUNT == 2
    gServerMgmtConfiguration.BmcLan2 = Unspecified;
#endif
    ...
    //
    if ( BmcLanIp1SetupValues.BmcLan == StaticAddress ) {
    ...
    // Configure Static address source parameters to BMC
    //
    if ( BmcLanIp2SetupValues.BmcLan == StaticAddress ) {
        SetStaticBmcNetworkParameters (BMC_LAN2_CHANNEL_NUMBER, BmcLanIp2SetupValues );
    }
#endif

    SERVER_IPMI_DEBUG ((EFI_D_LOAD, " Exiting......... InitializeBmcLanConfig \n"));
    return EFI_SUCCESS;
}
