    ...
    switch(Type) {
        ...
        case 2:
            ...
            *OutputUnicodeString = AllocateRuntimeZeroPool ((((Length * 8) / 3) + 2));
            if (*OutputUnicodeString != NULL) {
//TH0189>>>
            	if (*(UINT16*)(InputDataBuffer + 1) == 0x0000)
            		IpmiAscii2Unicode (*OutputUnicodeString, "NULL", sizeof("NULL"));
            	else
//TH0189<<<
  ...
  IN BOOLEAN                      GenerateDummySmbiosRecords )
{
    ...
    SERVER_IPMI_DEBUG ((EFI_D_LOAD, " GenerateFruSmbiosData entered... GenerateDummySmbiosRecords: %x\n", GenerateDummySmbiosRecords));
    //
    ...
    if ( !GenerateDummySmbiosRecords ) {
        ...
        if  ( CalculateCheckSum8 ((UINT8 *)&FruCommonHeader, sizeof (FruCommonHeader)) != 0 ){
            DEBUG((EFI_D_LOAD, "FRU header invalid.\n"));
            //
                ...
                if (!EFI_ERROR (Status)) {
                    ...
                    if ( CalculateCheckSum8 (TempPtr, Length) == 0 ) {
                        ...
                        if (!EFI_ERROR (Status)) {
                            ...
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "SystemManufacturer: ManufacturerString: %S\n", ManufacturerString));
                            PcdSetPtr (PcdSystemManufacturer, &SizeofBuffer, (VOID*)ManufacturerString);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "SystemManufacturer: %S\n", (CHAR16 *) PcdGetPtr (PcdSystemManufacturer)));
                        }
                        ...
                        //
                        if (!EFI_ERROR (Status)) {
#if PRODUCT_NAME_WITH_MODEL_NO	//TH0107
                            ...
                            if (!EFI_ERROR (Status)) {
                                ...
                                SERVER_IPMI_DEBUG ((EFI_D_LOAD, "SystemProductName: ProductName: %S\n", ProductName));
                        ...
                        if (!EFI_ERROR (Status)) {
                            ...
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdSystemVersion: StrPtr: %S \n", StrPtr));
                            PcdSetPtr (PcdSystemVersion, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdSystemVersion: %S\n", (CHAR16 *) PcdGetPtr (PcdSystemVersion)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdSystemSerialNumber: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdSystemSerialNumber, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdSystemSerialNumber: %S\n", (CHAR16 *) PcdGetPtr (PcdSystemSerialNumber)));
                            FreePool (StrPtr);
                        }
                ...
                if (!EFI_ERROR (Status)) {
                    ...
                    if ( CalculateCheckSum8 ( TempPtr, Length ) == 0 ) {
                        ...
                        if ( AssetTagString != NULL ) {
                            ...
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "AssetTagString: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardAssetTag, &SizeofBuffer, (VOID*)AssetTagString);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardAssetTag: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardAssetTag)));
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardManufacturer: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardManufacturer, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardManufacturer: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardManufacturer)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardProductName: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardProductName, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardProductName: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardProductName)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize(StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardSerialNumber: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardSerialNumber, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardSerialNumber: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardSerialNumber)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardVersion: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdBaseBoardVersion, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdBaseBoardVersion: %S\n", (CHAR16 *) PcdGetPtr (PcdBaseBoardVersion)));
                            FreePool (StrPtr);
                        }
                    }
                }
            ...
            if (TempPtr != NULL) {
                ...
                if (!EFI_ERROR (Status)) {
                    ...
                    if ( CalculateCheckSum8 ( TempPtr, Length ) == 0 ) {
                        ...
                        SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisType: %x\n", PcdGet8 (PcdChassisType) ));
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize(StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisVersion: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdChassisVersion, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisVersion: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisVersion)));
                            FreePool (StrPtr);
                        }
                        ...
                        if (!EFI_ERROR (Status)) {
                            SizeofBuffer = StrSize (StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisSerialNumber: StrPtr: %S\n", StrPtr));
                            PcdSetPtr (PcdChassisSerialNumber, &SizeofBuffer, (VOID*)StrPtr);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisSerialNumber: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisSerialNumber)));
                            FreePool (StrPtr);
                        }
                        ...
                        if ( ManufacturerString != NULL ) {
                            SizeofBuffer = StrSize (ManufacturerString);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisManufacturer: ManufacturerString: %S\n", ManufacturerString));
                            PcdSetPtr (PcdChassisManufacturer, &SizeofBuffer, (VOID*)ManufacturerString);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisManufacturer: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisManufacturer)));
                        }
                        //
                        // Fill the AssertTag
                        //
                        if ( AssetTagString != NULL ) {
                            SizeofBuffer = StrSize (AssetTagString);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisAssetTag: AssetTagString: %S\n", AssetTagString));
                            PcdSetPtr (PcdChassisAssetTag, &SizeofBuffer, (VOID*)AssetTagString);
                            SERVER_IPMI_DEBUG ((EFI_D_LOAD, "PcdChassisAssetTag: %S\n", (CHAR16 *) PcdGetPtr (PcdChassisAssetTag)));
                        }
                    }
                }
                FreePool (TempPtr);
    ...
    if ((Offset > 0) && !GenerateDummySmbiosRecords) {
        SERVER_IPMI_DEBUG ((EFI_D_LOAD, "Multirecord Info Area present\n"));
        do {
            ...
            if (!EFI_ERROR(Status)) {
                ...
                if ( CalculateCheckSum8 ((UINT8 *)&MultiRecordHeader, sizeof (IPMI_FRU_MULTI_RECORD_HEADER)) != 0 ){
                    DEBUG((EFI_D_LOAD, "FRU MultiRecord Record invalid.\n"));
                    break;
                }
                ...
                if ((MultiRecordHeader.RecordTypeId != MANAGEMENT_ACCESS_RECORD) && (!(MultiRecordHeader.EndofList)) ) {
                    ...
                    if ( MultiRecordHeader.RecordTypeId == MANAGEMENT_ACCESS_RECORD ) { // Management Access Record found
                        ...
                        //
                        SERVER_IPMI_DEBUG ((EFI_D_LOAD, "Management Access record found\n"));
                        ...
                        if (!(EFI_ERROR(Status))) {
                            if (SubRecordType == SYSTEM_UUID_SUB_RECORD_TYPE) {
                                ...
                                if ((CalculateCheckSum8 ((UINT8 *)&SystemUuidSubRecordwithChecksum, sizeof(SystemUuidSubRecordwithChecksum))) == 0) {
                                    ...
                                    //
                                    SERVER_IPMI_DEBUG ((EFI_D_LOAD, "System UUID Sub Record Type found and Checksum OK!!!\n"));
