...
//TH0053>>>
    		STRING_TOKEN (STR_EVENT_LOG_TYPE_IDE_DEVICE_FAILURE),
    		STRING_TOKEN (STR_EVENT_LOG_TYPE_FLASH_UPDATE_FAILED),
    		STRING_TOKEN (STR_EVENT_LOG_TYPE_PCI_BUS_OUT_OF_RESOURCES),
    		STRING_TOKEN (STR_EVENT_LOG_TYPE_LEGACY_OPROM_NO_SPACE),
    		STRING_TOKEN (STR_EVENT_LOG_TYPE_PASSWORD_INVALIDED),
//TH0053<<<     
        STRING_TOKEN (STR_EVENT_LOG_TYPE_CLEAR_CMOS),//TH0095   
