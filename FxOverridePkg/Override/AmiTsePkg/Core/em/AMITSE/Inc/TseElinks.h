...
VOID FxHandleSaveAndExit(VOID);//GCH001002+
VOID FxHandleSaveWithoutExit(VOID);//GCH001002+
VOID FxHandleSaveAndReset(VOID); //GCH001002+
VOID UpdateSystemInfoToBmc ();//GCH001002+
