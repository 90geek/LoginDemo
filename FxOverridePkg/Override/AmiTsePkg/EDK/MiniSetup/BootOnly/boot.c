...
//TH0179>>>          	
					//
					//Log:Removable Boot Media Not Found into SEL.  
					// 
					EfiLibReportStatusCode(EFI_ERROR_CODE| EFI_ERROR_MAJOR, EFI_PERIPHERAL_REMOVABLE_MEDIA | EFI_P_EC_CONTROLLER_ERROR,0,NULL,NULL); 
//TH0179<<<
					UefiBootFailHook (Status);
				}
