...
#include "ReFlash.h"
#include "AmiCRBPkg\Board\SB\SB.h" //TH0041
...
{
	  BOOLEAN IsRecovery = FALSE;	//TH0041
...
#endif
    if(IsRecovery) {
        DrawMessageBox(L"Flash update", L"Flash update completed. Press Enter key to shutdown the system");
