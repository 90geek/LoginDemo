...
//TH0035 >>>>
STATE_DESCRIPTION wipmitoolF6SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_F6, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitoolF7SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_F7, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitoolF8SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_F8, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitoolF9SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_F9, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitoolF10SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_F10, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitoolF11SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_F11, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitoolF12SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_F12, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitool_F1_5_SeqStateArray[] = 
{

	{'A', NULL, EFI_SCAN_F1, 0, GLOBAL_ALL},	
	{'B', NULL, EFI_SCAN_F2, 0, GLOBAL_ALL},	
	{'C', NULL, EFI_SCAN_F3, 0, GLOBAL_ALL},	
	{'D', NULL, EFI_SCAN_F4, 0, GLOBAL_ALL},	
	{'E', NULL, EFI_SCAN_F5, 0, GLOBAL_ALL},	
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitool_Home_F6_8_SeqStateArray[] = 
{
	{'~', NULL, EFI_SCAN_HOME,  0, GLOBAL_ALL},	
	{'7', wipmitoolF6SeqStateArray, 0, 0, GLOBAL_ALL}, 
	{'8', wipmitoolF7SeqStateArray, 0, 0, GLOBAL_ALL}, 
	{'9', wipmitoolF8SeqStateArray, 0, 0, GLOBAL_ALL}, 
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitool_Inst_F9_12_SeqStateArray[] = 
{
	{'~', NULL, EFI_SCAN_INS,  0, GLOBAL_ALL},	
	{'0', wipmitoolF9SeqStateArray, 0, 0, GLOBAL_ALL}, 
	{'1', wipmitoolF10SeqStateArray, 0, 0, GLOBAL_ALL}, 
	{'3', wipmitoolF11SeqStateArray, 0, 0, GLOBAL_ALL}, 
	{'4', wipmitoolF12SeqStateArray, 0, 0, GLOBAL_ALL},
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitool_Del_SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_DEL, 0, GLOBAL_ALL},	
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitool_End_SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_END, 0, GLOBAL_ALL},	
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitool_Pgup_SeqStateArray[] = 
{
    {'~', NULL, EFI_SCAN_PGUP, 0, GLOBAL_ALL},	
    ESC_SEQ_STATE_ARRAY_END_MARKER
};

STATE_DESCRIPTION wipmitool_Pgdn_SeqStateArray[] = 
{
...
STATE_DESCRIPTION CursorPositionEscSeqStateArray[] =
{
    ...
    //TH0035 >>>>
    {'[', wipmitool_F1_5_SeqStateArray, 0, 0, GLOBAL_ALL},	
    {'1', wipmitool_Home_F6_8_SeqStateArray, 0, 0, GLOBAL_ALL},	
    {'2', wipmitool_Inst_F9_12_SeqStateArray, 0, 0, GLOBAL_ALL},	
    {'3', wipmitool_Del_SeqStateArray, 0, 0, GLOBAL_ALL},	
    {'4', wipmitool_End_SeqStateArray, 0, 0, GLOBAL_ALL},	
    {'5', wipmitool_Pgup_SeqStateArray, 0, 0, GLOBAL_ALL},	
    {'6', wipmitool_Pgdn_SeqStateArray, 0, 0, GLOBAL_ALL},	
    //TH0035< <<<
