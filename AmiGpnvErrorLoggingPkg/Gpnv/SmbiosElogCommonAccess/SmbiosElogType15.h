...
//TH0053>>>
  {EFI_EVENT_LOG_TYPE_OEM_IDE_DEVICE_FAIL,
      EFI_EVENT_LOG_VAR_DATA_TYPE_NONE },
      
  {EFI_EVENT_LOG_TYPE_OEM_FLASH_UPDATE_FAILED,
      EFI_EVENT_LOG_VAR_DATA_TYPE_NONE },
      
  {EFI_EVENT_LOG_TYPE_PCI_BUS_OUT_OF_RESOURCES,
      EFI_EVENT_LOG_VAR_DATA_TYPE_NONE },
      
  {EFI_EVENT_LOG_TYPE_LEGACY_OPROM_NO_SPACE,
      EFI_EVENT_LOG_VAR_DATA_TYPE_NONE },
      
  {EFI_EVENT_LOG_TYPE_PASSWORD_INVALIDED,
      EFI_EVENT_LOG_VAR_DATA_TYPE_NONE },   
//TH0053<<<

//TH0095 >>>>
  {EFI_EVENT_LOG_TYPE_CLEAR_CMOS,
      EFI_EVENT_LOG_VAR_DATA_TYPE_NONE },
//TH0095 <<<<
