...
#define CMOS_LAYOUT_CHECKSUM 0x062      // Checksum
#define FIRST_CMOS_REGISTER 0x00040     // First CMOS Register
#define LAST_CMOS_REGISTER 0x00046      // Last CMOS Register
#define TOTAL_CMOS_TOKENS 0x0000B       // Total number of tokens
#define TOTAL_NOT_CHECKSUMMED 0x00002   // Total number of CMOS registers not checksummed
...
CmosTokenTable("CMOSMGR_RSTE_BOOT_INFO_OFFSET", 0x2230)
CmosTokenTable("CMOS_MGR_BATTERY_BAD", 0x1232)
CmosTokenTable("CMOS_MGR_CHECKSUM_BAD", 0x1233)
CmosTokenTable("CMOS_MGR_DEFAULTS_LOADED", 0x1234)
CmosTokenTable("CMOS_MGR_FIRST_BOOT_DETECTED", 0x1235)
