...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x62EB9C56, 0xA79C, 0x4423, {0xA7, 0xF0, 0x89, 0x1A, 0x34, 0x52, 0x08, 0xCD}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IioDmiInitPeim";
...
{
  return IioDmiInitPeiEntryPoint (FileHandle, PeiServices);
}
