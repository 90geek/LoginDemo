...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x147B4839, 0x5DBE, 0x413f, {0x91, 0x7F, 0xDF, 0xEB, 0x68, 0x7C, 0x63, 0x12}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchResetPeim";
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchResetCallbackPpiGuid = { 0xdbdb5326, 0x3351, 0x489d, { 0x9f, 0x6a, 0x30, 0xe6, 0xa2, 0x2f, 0xdf, 0xf6 }};
...
{
  return InstallPchReset (FileHandle, PeiServices);
}
