...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1D88C542, 0x9DF7, 0x424a, {0xAA, 0x90, 0x02, 0xB6, 0x1F, 0x28, 0x69, 0x38}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "WdtPei";
...
{
  return WdtPeiEntryPoint (FileHandle, PeiServices);
}
