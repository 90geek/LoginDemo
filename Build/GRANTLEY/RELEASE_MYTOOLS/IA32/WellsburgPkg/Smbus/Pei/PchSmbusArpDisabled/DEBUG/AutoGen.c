...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x643DF777, 0xF312, 0x42ed, {0x81, 0xCC, 0x1B, 0x1F, 0x57, 0xE1, 0x8A, 0xD6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchSmbusArpDisabled";
...
{
  return InitializePchSmbusPeim (FileHandle, PeiServices);
}
