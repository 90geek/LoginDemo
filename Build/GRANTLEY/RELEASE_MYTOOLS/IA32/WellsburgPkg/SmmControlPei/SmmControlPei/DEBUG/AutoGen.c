...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x60EC7720, 0x512B, 0x4490, {0x9F, 0xD1, 0xA3, 0x36, 0x76, 0x9A, 0xE0, 0x1F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmControlPei";
...
{
  return SmmControlPeiEntry (FileHandle, PeiServices);
}
