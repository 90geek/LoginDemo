...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x34CC6167, 0x7AE7, 0x403e, {0x8A, 0xB2, 0x23, 0x83, 0x7F, 0x39, 0x8A, 0x30}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformInfo";
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPeiSpiPpiGuid = { 0xa38c6898, 0x2b5c, 0x4ff6, { 0x93, 0x26, 0x2e, 0x63, 0x21, 0x2e, 0x56, 0xc2 } };
...
{
  return PlatformInfoInit (FileHandle, PeiServices);
}
