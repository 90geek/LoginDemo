...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6540F933, 0x425F, 0x464b, {0xB4, 0xAD, 0xB9, 0x3A, 0x6E, 0xD0, 0xA8, 0xF5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OcInit";
...
{
  return OcEntryPoint (FileHandle, PeiServices);
}
