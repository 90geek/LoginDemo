...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xEFD652CC, 0x0E99, 0x40f0, {0x96, 0xC0, 0xE0, 0x8C, 0x08, 0x90, 0x70, 0xFC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "S3Resume";
...
{
  return S3ResumeEntryPoint (FileHandle, PeiServices);
}
