...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1988a1d8, 0x04fc, 0x4d68, {0xb5, 0x8d, 0x63, 0x6f, 0x36, 0xf3, 0x0d, 0x82}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SoftStrapsPeim";
...
{
  return SoftStrapsPeimEntryPoint (FileHandle, PeiServices);
}
