...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xd133c000, 0x7911, 0x4e7f, {0xab, 0xff, 0x71, 0xf1, 0x4f, 0x33, 0x37, 0xa8}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HomeWorkPeim";
...
{
  return HomeWorkPeimEntryPoint (FileHandle, PeiServices);
}
