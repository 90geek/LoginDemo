...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xe60a79d5, 0xdc9b, 0x47f1, {0x87, 0xd3, 0x51, 0xbf, 0x69, 0x7b, 0x61, 0x21}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuPeiDummy";
...
{
  return CpuPeiDummyEntry (FileHandle, PeiServices);
}
