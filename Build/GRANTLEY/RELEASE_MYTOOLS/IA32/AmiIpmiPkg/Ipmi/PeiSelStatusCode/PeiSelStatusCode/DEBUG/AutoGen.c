...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2700F72F, 0xE0EA, 0x4767, {0x9A, 0x1E, 0xD1, 0x72, 0xF0, 0x70, 0x47, 0x78}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PeiSelStatusCode";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPeiSelPpiGuid = { 0xe50b6e5d, 0x359b, 0x4be0, { 0xa0, 0xb0, 0x7, 0x15, 0xa3, 0x1, 0xa6, 0x6 } };
...
{
  return InitializePeiSel (FileHandle, PeiServices);
}
