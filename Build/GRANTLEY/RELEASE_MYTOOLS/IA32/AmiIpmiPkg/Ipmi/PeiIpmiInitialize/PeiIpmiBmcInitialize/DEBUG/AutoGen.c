...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7942EDD0, 0xC023, 0x4357, {0x93, 0xED, 0xF6, 0x62, 0x6D, 0x71, 0x1E, 0x9E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PeiIpmiBmcInitialize";
...
{
  return InitializeIpmiPhysicalLayer (FileHandle, PeiServices);
}
