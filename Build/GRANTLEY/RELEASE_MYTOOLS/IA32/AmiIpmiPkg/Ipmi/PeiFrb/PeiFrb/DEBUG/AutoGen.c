...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0EF53039, 0x3A38, 0x42d1, {0xBC, 0xEC, 0xCE, 0x96, 0x6E, 0x87, 0x06, 0x1A}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PeiFrb";
...
{
  return InitializePeiFrb (FileHandle, PeiServices);
}
