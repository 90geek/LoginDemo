...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xcdc1c80d, 0xe6d3, 0x4a42, {0x92, 0x29, 0x75, 0xf3, 0xbe, 0xfc, 0xf1, 0x09}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PciOutOfResourceSetupPage";
...
{
  return PciOutOfResourceSetupPageEntry (ImageHandle, SystemTable);
}
