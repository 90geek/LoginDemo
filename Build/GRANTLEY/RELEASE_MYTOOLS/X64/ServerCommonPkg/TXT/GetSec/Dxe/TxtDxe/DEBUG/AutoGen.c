...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xFF917E22, 0xA228, 0x448d, {0xBD, 0xAA, 0x68, 0xEF, 0xCC, 0xDD, 0xA5, 0xD3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TxtDxe";
  ...
  )
{
  ...
  Status = LtDxeLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
