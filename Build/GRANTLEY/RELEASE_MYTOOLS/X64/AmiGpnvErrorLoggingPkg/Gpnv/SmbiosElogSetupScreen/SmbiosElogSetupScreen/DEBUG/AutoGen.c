...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2DDFEDFE, 0xC2D5, 0x43e3, {0x9E, 0x10, 0x46, 0xDB, 0x2C, 0x7C, 0x1F, 0x26}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosElogSetupScreen";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmbiosElogSupportGuid = { 0x0e5870e4, 0x0525, 0x40ad, 0x95, 0xa8, 0x0f, 0xff, 0x15, 0x5b, 0x8f, 0xc0 };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEventLogsDynamicGuid = { 0xdd51ab78, 0xe55d, 0x4413, 0xaf, 0xae, 0xe5, 0x92, 0xf6, 0xb5, 0x32, 0x1b };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEventLogsHiiHandleGuidx = { 0x55cf7cce, 0x051f, 0x42c3, 0x9c, 0xa9, 0x20, 0xdb, 0x5c, 0xad, 0x9a, 0xe4 };
...
{
  return InstallErrorSetupScreen (ImageHandle, SystemTable);
}
