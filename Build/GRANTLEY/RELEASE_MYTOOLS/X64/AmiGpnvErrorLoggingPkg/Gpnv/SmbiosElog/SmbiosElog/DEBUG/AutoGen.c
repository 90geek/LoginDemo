...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x13C5506E, 0x8231, 0x415e, {0x9E, 0xBC, 0x88, 0xDD, 0x11, 0x5E, 0x38, 0x18}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosElog";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSmmDummyProtocolRedirGuid = { 0x9c72f7fb, 0x86b6, 0x406f, 0xb8, 0x6e, 0xf3, 0x80, 0x9a, 0x86, 0xc1, 0x38 };
...
{
  return InitializeSmbiosElog (ImageHandle, SystemTable);
}
