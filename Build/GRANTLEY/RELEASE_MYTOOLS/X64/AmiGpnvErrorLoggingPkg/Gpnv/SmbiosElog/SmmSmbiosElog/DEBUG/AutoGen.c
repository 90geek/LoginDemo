...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8E61FD6B, 0x7A8B, 0x404f, {0xB8, 0x3F, 0xAA, 0x90, 0xA4, 0x7C, 0xAB, 0xDF}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmSmbiosElog";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeSmmSmbiosElog (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
