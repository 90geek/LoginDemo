...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x63809859, 0xF029, 0x41c3, {0x9F, 0x34, 0xEE, 0xEB, 0x9E, 0xA7, 0x87, 0xA5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IioInit";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gReadyForLockProtocolGuid = { 0x8d6f1add, 0x45a5, 0x45a8, { 0x8b, 0xb8, 0x0c, 0x3a, 0x95, 0x31, 0x48, 0xfa }};
...
#define _PCD_SIZE_PcdLockCsrSsidSvidRegister 1
#define _PCD_GET_MODE_SIZE_PcdLockCsrSsidSvidRegister  _PCD_SIZE_PcdLockCsrSsidSvidRegister 
#define _PCD_VALUE_PcdLockCsrSsidSvidRegister  ((BOOLEAN)1U)
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdLockCsrSsidSvidRegister = _PCD_VALUE_PcdLockCsrSsidSvidRegister;
...
{
  return IioInitEntry (ImageHandle, SystemTable);
}
