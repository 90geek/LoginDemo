...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3FFCAE95, 0x23CF, 0x4967, {0x94, 0xF5, 0x16, 0x35, 0x2F, 0x68, 0xE4, 0x3B}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PpmInitialize";
...
{
  return PpmInitializeEntry (ImageHandle, SystemTable);
}
