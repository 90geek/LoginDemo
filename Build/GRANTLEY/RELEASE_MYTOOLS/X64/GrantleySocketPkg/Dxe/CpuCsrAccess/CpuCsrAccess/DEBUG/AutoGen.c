...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x06D20D84, 0xA032, 0x4e25, {0x96, 0x9A, 0x34, 0x6D, 0x25, 0x5E, 0x46, 0xD1}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuCsrAccess";
...
{
  return CpuCsrAccessStart (ImageHandle, SystemTable);
}
