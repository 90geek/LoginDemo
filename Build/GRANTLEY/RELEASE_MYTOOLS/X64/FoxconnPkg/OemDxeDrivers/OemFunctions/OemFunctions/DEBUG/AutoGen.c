...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD154D046, 0xA6DC, 0x496b, {0x87, 0x41, 0xA6, 0x19, 0x1E, 0x8A, 0xF2, 0xE3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OemFunctions";
...
{
  return RegisterOemFunctions (ImageHandle, SystemTable);
}
