...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0389B16E, 0xF382, 0x4e84, {0x89, 0x95, 0x69, 0x9B, 0x4A, 0x00, 0x1A, 0x56}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ModifyBiosConfigOverBmc";
...
{
  return ModifyBiosConfig (ImageHandle, SystemTable);
}
