...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x43a12ef5, 0x0372, 0x4119, {0x9f, 0x0f, 0x00, 0x0a, 0x8c, 0x10, 0x4c, 0x62}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HomeWorkDxe";
...
{
  return HomeWorkDxeEntryPoint (ImageHandle, SystemTable);
}
