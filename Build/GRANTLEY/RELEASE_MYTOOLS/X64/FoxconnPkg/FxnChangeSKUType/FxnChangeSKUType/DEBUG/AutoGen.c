...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xd77d6cb0, 0x2db2, 0x11e8, {0x9c, 0x2e, 0x00, 0x50, 0x56, 0xc0, 0x00, 0x08}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FxnChangeSKUType";
...
{
  return FxnChangeSKUTypeEntryPoint (ImageHandle, SystemTable);
}
