...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5AAB83E5, 0xF027, 0x4ca7, {0xBF, 0xD0, 0x16, 0x35, 0x8C, 0xC9, 0xE4, 0x53}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "WdtDxe";
...
{
  return WdtDxeEntryPoint (ImageHandle, SystemTable);
}
