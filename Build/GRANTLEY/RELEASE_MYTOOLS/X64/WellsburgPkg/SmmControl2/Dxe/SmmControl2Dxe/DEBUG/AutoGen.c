...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBA31025C, 0x4AA8, 0x4cae, {0x98, 0xCA, 0xBA, 0x12, 0xC6, 0xBC, 0x7D, 0x78}};
...
#define _PCD_PATCHABLE_VALUE_PcdDebugPrintErrorLevel  ((UINT32)0x80000000U)
