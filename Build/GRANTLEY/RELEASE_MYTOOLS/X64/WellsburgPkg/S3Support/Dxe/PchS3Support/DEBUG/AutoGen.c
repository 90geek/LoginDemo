...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC7EA9787, 0xCA0A, 0x43b4, {0xB1, 0xE5, 0x25, 0xEF, 0x87, 0x39, 0x1F, 0x8D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchS3Support";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchInitVariableGuid = {  0xe6c2f70a, 0xb604, 0x4877, { 0x85, 0xba, 0xde, 0xec, 0x89, 0xe1, 0x17, 0xeb }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchS3ImageGuid = { 0x271dd6f2, 0x54cb, 0x45e6, { 0x85, 0x85, 0x8c, 0x92, 0x3c, 0x1a, 0xc7, 0x6 }};
...
{
  return PchS3SupportEntryPoint (ImageHandle, SystemTable);
}
