...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2EE81ACB, 0x64B2, 0x41ae, {0x86, 0x35, 0x70, 0x30, 0xD1, 0x6C, 0x4A, 0xA8}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchBiosWriteProtect";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmmIchnDispatch2ProtocolGuid = { 0xe0f0cc19, 0x8912, 0x4077, {0xbf, 0x8a, 0x6a, 0x5c, 0x27, 0xa, 0x3e, 0x65}};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InstallPchBiosWriteProtect (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
