...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1015EA63, 0x7421, 0x417d, {0xBB, 0x51, 0xE5, 0x19, 0x30, 0x61, 0xC5, 0x51}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DxeIpmiUsb";
...
{
  return DxeIpmiUsbEntryPoint (ImageHandle, SystemTable);
}
