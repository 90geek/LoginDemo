...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBC0B9FB8, 0x97CF, 0x4b17, {0x9A, 0x9E, 0xF5, 0x74, 0xE6, 0x2C, 0xBC, 0xC4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BmcLanConfig";
...
{
  return InitializeBmcLanConfig (ImageHandle, SystemTable);
}
