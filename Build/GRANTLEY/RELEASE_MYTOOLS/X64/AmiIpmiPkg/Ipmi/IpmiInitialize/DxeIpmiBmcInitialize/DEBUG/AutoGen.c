...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6372357A, 0x06D7, 0x43ef, {0xB5, 0x5C, 0x19, 0x64, 0xF3, 0xDD, 0x69, 0x16}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DxeIpmiBmcInitialize";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiIpmiCmosClearVariableGuid = { 0x675b8766, 0x7f03, 0x4181, { 0x9b, 0xe1, 0x73, 0xbc, 0x45, 0xdf, 0xf7, 0x99 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmmIpmiTransportProtocolGuid = { 0x1dbd1503, 0xa60, 0x4230, { 0xaa, 0xa3, 0x80, 0x16, 0xd8, 0xc3, 0xde, 0x2f } };
...
{
  return InitializeIpmiPhysicalLayer (ImageHandle, SystemTable);
}
