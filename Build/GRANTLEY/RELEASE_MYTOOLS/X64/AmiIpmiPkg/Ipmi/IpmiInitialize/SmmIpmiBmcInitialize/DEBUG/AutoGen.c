...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE8C729FE, 0xFB0A, 0x4344, {0xAD, 0x7E, 0x48, 0x78, 0x41, 0x16, 0xC9, 0xEF}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmIpmiBmcInitialize";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeIpmiSmmPhysicalLayer (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
