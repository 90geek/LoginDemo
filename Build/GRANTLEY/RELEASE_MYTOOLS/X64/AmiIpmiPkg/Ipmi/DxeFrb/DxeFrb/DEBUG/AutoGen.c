...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9D0CEA63, 0x745B, 0x417d, {0xBB, 0xA4, 0xE5, 0x19, 0x30, 0x61, 0xC9, 0x07}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DxeFrb";
...
{
  return InitializeDxeFrb (ImageHandle, SystemTable);
}
