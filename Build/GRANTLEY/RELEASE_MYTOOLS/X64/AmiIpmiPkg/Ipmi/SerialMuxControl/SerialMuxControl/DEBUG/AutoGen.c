...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x129F6AA7, 0xAB69, 0x4cb8, {0xAE, 0xD1, 0x40, 0x98, 0x50, 0x01, 0x11, 0x5E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SerialMuxControl";
...
{
  return SerialMuxControlEntryPoint (ImageHandle, SystemTable);
}
