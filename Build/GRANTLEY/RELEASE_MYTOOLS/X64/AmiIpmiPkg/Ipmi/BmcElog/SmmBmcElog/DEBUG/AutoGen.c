...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x543323CE, 0x9F0C, 0x4ddf, {0xA3, 0x3C, 0xBC, 0x3B, 0x3A, 0x5A, 0xC2, 0x27}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmBmcElog";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeSmmBmcElog (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
