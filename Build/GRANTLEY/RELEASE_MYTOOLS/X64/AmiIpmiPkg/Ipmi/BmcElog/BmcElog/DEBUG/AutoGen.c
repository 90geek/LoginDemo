...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x43788BEB, 0x638F, 0x434c, {0x8A, 0x84, 0x46, 0xD3, 0x3A, 0x58, 0x9E, 0x76}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BmcElog";
...
{
  return InitializeBmcElog (ImageHandle, SystemTable);
}
