...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAE587172, 0xCC15, 0x48e1, {0x8B, 0xE0, 0x29, 0xDD, 0xF0, 0x5C, 0x6A, 0x1F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DxeSelStatusCode";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSelStatusCodeProtocolGuid = { 0xbc5f861c, 0x86ed, 0x417e, { 0xbb, 0x7b, 0x6c, 0x2, 0x6b, 0xdc, 0x65, 0x23 } };
...
{
  return InitializeDxeSel (ImageHandle, SystemTable);
}
