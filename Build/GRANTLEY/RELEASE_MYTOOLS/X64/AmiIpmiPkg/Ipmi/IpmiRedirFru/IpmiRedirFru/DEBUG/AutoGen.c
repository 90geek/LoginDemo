...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8F2C127E, 0x117D, 0x484B, {0x8A, 0x44, 0xFB, 0xD9, 0x11, 0xBE, 0x12, 0x5E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IpmiRedirFru";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiRedirFruProtocolGuid = { 0x28638cfa, 0xea88, 0x456c, { 0x92, 0xa5, 0xf2, 0x49, 0xca, 0x48, 0x85, 0x35 } };
...
{
  return InitializeSmRedirFruLayer (ImageHandle, SystemTable);
}
