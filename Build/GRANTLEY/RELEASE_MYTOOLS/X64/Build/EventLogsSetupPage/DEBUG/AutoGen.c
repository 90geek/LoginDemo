...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xFFE0FCDC, 0x809A, 0x4d48, {0xA0, 0x60, 0x6A, 0x8A, 0x6A, 0x26, 0x91, 0x76}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "EventLogsSetupPage";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEventLogsFormsetGuid = { 0x8BEB8C19, 0x3FEC, 0x4fab, 0xA3, 0x78, 0xC9, 0x03, 0xE8, 0x90, 0xFC, 0xAE };
...
{
  return EventLogsSetupPageEntry (ImageHandle, SystemTable);
}
