...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1B08A1DB, 0xF91A, 0x4fa1, {0xA9, 0x11, 0x25, 0x5C, 0x41, 0x7F, 0x1C, 0xF7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ServerMgmtSetup";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiServerMgmtSetupVariableGuid = { 0x1239999, 0xfc0e, 0x4b6e, { 0x9e, 0x79, 0xd5, 0x4d, 0x5d, 0xb6, 0xcd, 0x20 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiIpmiPkgTokenSpaceGuid = { 0x1e21c326, 0xd40, 0x40f2, { 0x9f, 0x2, 0x3a, 0x9b, 0x78, 0x38, 0xaa, 0x6b } };
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiBmcSelfTestLogProtocolGuid = { 0x9FE6A332, 0x1A1F, 0x43e3, { 0xBD, 0x25, 0xF7, 0x89, 0x1C, 0x6F, 0xC7, 0x4A } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiDxeIpmiUsbTransportProtocolGuid = { 0x42D353B0, 0x8C1E, 0x4ACA, { 0xBE, 0xAC, 0x28, 0xFB, 0x24, 0xF2, 0x0C, 0x42 } };

// Definition of PCDs used in this module
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdStrMfg[6] = {73, 110, 116, 101, 108, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdStrProduct[7] = {69, 80, 71, 83, 86, 82, 0 };
  ...
  )
{
  ...
  Status = IpmiInterfaceLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return InstallServerMgmtSetupScreen (ImageHandle, SystemTable);
}
