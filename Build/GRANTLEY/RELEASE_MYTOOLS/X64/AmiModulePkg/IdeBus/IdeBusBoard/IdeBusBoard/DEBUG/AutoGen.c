...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x00364A4C, 0x6A0A, 0x4f08, {0x8F, 0xFD, 0x09, 0x37, 0xF3, 0xDB, 0xB1, 0x3E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IdeBusBoard";
...
{
  return IdeBusBoardEntryPoint (ImageHandle, SystemTable);
}
