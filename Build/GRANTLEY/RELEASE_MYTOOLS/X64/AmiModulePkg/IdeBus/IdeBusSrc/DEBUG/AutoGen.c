...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAAECDC89, 0x2A49, 0x46f1, {0xA1, 0x63, 0xF7, 0x97, 0x9C, 0x03, 0x99, 0x98}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IdeBusSrc";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiHddHpaProtocolGuid = { 0x51AA65FC, 0x82B6, 0x49E6, { 0x95, 0xE2, 0xE6, 0x82, 0x7A, 0x8D, 0x7D, 0xB4 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiHddPowerMgmtProtocolGuid = { 0x67BC3883, 0x7E79, 0x4BC1, { 0xA3, 0x3E, 0x3A, 0xF7, 0xD1, 0x75, 0x89, 0xBA } };
...
{
  return IdeBusEntryPoint (ImageHandle, SystemTable);
}
