...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x952821AA, 0xEACD, 0x465b, {0xB4, 0x78, 0x54, 0x29, 0xDF, 0xC9, 0xA7, 0x47}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OA2";
...
{
  return OA2_EntryPoint (ImageHandle, SystemTable);
}
