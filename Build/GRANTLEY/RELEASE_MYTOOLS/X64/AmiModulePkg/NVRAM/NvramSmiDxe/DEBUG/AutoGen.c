...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x54B070F3, 0x9EB8, 0x47CC, {0xAD, 0xAF, 0x39, 0x02, 0x9C, 0x85, 0x3C, 0xBB}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NvramSmiDxe";
...
{
  return NvramSmiDxeEntry (ImageHandle, SystemTable);
}
