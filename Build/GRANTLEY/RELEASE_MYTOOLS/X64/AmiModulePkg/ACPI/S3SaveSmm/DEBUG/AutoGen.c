...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x413B1952, 0xD564, 0x4aeb, {0x8C, 0xDA, 0x83, 0x53, 0x16, 0x15, 0x00, 0xBC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "S3SaveSmm";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiBootScriptSaveProtocolGuid = { 0x470e1529, 0xb79e, 0x4e32, { 0xa0, 0xfe, 0x6a, 0x15, 0x6d, 0x29, 0xf9, 0xb2 }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitBootScript (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
