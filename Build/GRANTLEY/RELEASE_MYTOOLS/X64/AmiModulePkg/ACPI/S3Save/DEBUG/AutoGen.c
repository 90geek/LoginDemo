...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x26A2481E, 0x4424, 0x46a2, {0x99, 0x43, 0xCC, 0x40, 0x39, 0xEA, 0xD8, 0xF8}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "S3Save";
...
{
  return AcpiS3SaveEntryPoint (ImageHandle, SystemTable);
}
