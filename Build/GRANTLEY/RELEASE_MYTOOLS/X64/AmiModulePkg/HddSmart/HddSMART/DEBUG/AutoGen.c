...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD57C852E, 0x809F, 0x45cf, {0xA3, 0x77, 0xD7, 0x7B, 0xC0, 0xCB, 0x78, 0xEE}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HddSmart";
...
{
  return HddSmartEntryPoint (ImageHandle, SystemTable);
}
