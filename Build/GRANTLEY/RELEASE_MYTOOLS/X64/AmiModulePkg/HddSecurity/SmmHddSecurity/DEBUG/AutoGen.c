...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x316B1230, 0x0500, 0x4592, {0x8C, 0x09, 0xEA, 0xBA, 0x0F, 0xB6, 0xB0, 0x7F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmHddSecurity";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (HddHDDPasswordSMMInit (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
