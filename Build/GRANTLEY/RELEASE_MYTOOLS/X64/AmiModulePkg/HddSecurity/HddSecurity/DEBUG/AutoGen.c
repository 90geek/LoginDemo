...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA9B700CF, 0x019E, 0x4d8b, {0xA3, 0xA7, 0x88, 0xE1, 0xEA, 0x01, 0x69, 0x9E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HddSecurity";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmmControlProtocolGuid = { 0x8d12e231, 0xc667, 0x4fd1, { 0x98, 0xf2, 0x24, 0x49, 0xa7, 0xe7, 0xb2, 0xe5 }};
...
{
  return HddSecurityEntryPoint (ImageHandle, SystemTable);
}
