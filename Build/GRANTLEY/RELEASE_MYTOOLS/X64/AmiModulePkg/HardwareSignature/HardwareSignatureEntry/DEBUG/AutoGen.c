...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB7EE4835, 0x84CE, 0x4b15, {0xBF, 0x52, 0x2D, 0x11, 0x57, 0x4C, 0xE4, 0x70}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HardwareSignatureEntry";
...
{
  return HardwareSignatureEntryPoint (ImageHandle, SystemTable);
}
