...
#define _PCD_TOKEN_PcdSupportUpdateCapsuleReset  153U
...
#define _PCD_TOKEN_PcdDxeIplSwitchToLongMode  110U
...
#define _PCD_TOKEN_PcdMaxSizePopulateCapsule  155U
...
#define _PCD_TOKEN_PcdIdentifyMappingPageTablePtr  27U
#define _PCD_GET_MODE_64_PcdIdentifyMappingPageTablePtr  LibPcdGet64(_PCD_TOKEN_PcdIdentifyMappingPageTablePtr)
#define _PCD_GET_MODE_SIZE_PcdIdentifyMappingPageTablePtr  LibPcdGetSize(_PCD_TOKEN_PcdIdentifyMappingPageTablePtr)
#define _PCD_SET_MODE_64_PcdIdentifyMappingPageTablePtr(Value)  LibPcdSet64(_PCD_TOKEN_PcdIdentifyMappingPageTablePtr, (Value))
#define _PCD_SET_MODE_64_S_PcdIdentifyMappingPageTablePtr(Value)  LibPcdSet64S(_PCD_TOKEN_PcdIdentifyMappingPageTablePtr, (Value))

#define _PCD_TOKEN_PcdCapsulePeiLongModeStackSize  156U
