...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7F8D35BD, 0x0CE3, 0x4654, {0xB5, 0xD3, 0x73, 0xFC, 0x4B, 0x38, 0xAA, 0xBF}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformEarlyDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiDprRegsProgrammedGuid = { 0x4b844201, 0x6fe9, 0x41d1, { 0xb4, 0x6f, 0xdf, 0xfc, 0x34, 0xe4, 0x92, 0xa2 }};
...
{
  return PlatformEarlyDxeEntry (ImageHandle, SystemTable);
}
