...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0F99E33C, 0xCA0C, 0x4aa2, {0x88, 0x7D, 0xB5, 0x7E, 0xC9, 0x05, 0x02, 0x78}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SaveMemoryConfig";
