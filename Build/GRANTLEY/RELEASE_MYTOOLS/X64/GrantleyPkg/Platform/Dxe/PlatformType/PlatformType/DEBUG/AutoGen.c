...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2E6A521C, 0xF697, 0x402d, {0x97, 0x74, 0x98, 0xB2, 0xB7, 0xE1, 0x40, 0xF3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformType";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdPostCompleteGpio = _PCD_VALUE_PcdPostCompleteGpio;
