...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x62DC08AC, 0xA651, 0x4EE9, {0xAF, 0x81, 0xEA, 0xA9, 0x26, 0x1E, 0x97, 0x80}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "S3NvramSave";
...
{
  return S3NvramSaveEntry (ImageHandle, SystemTable);
}
