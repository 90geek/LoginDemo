...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x56F80AA7, 0x87FB, 0x4f43, {0xBE, 0xE1, 0x0B, 0xA1, 0x8F, 0xAD, 0x4A, 0x06}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformResetSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializePlatformResetSmm (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
