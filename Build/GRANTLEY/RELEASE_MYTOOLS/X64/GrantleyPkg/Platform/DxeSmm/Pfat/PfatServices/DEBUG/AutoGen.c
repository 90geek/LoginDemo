...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6D4BAA0B, 0xF431, 0x4370, {0xAF, 0x19, 0x99, 0xD6, 0x20, 0x92, 0x39, 0xF6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PfatServices";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPfatModuleGuid = { 0x7934156D, 0xCFCE, 0x460e, { 0x92, 0xF5, 0xA0, 0x79, 0x09, 0xA5, 0x9E, 0xCA } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSmmPfatProtocolGuid = { 0xc3e156e4, 0x27b3, 0x4dff, { 0xb8, 0x96, 0xfb, 0x11, 0x3b, 0x2e, 0x68, 0xb5 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdFlashAreaBaseAddress = _PCD_VALUE_PcdFlashAreaBaseAddress;
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InstallPfatProtocol (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
