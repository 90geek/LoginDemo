...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x253E85E9, 0x993B, 0x439B, {0xB7, 0x4C, 0x61, 0x20, 0xF7, 0x7B, 0x47, 0x23}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformReset";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gDxePchPlatformResetPolicyProtocolGuid = {0x45ada968, 0xa8c5, 0x4f30, {0xac, 0xd4, 0xf5, 0x13, 0xbc, 0xe5, 0xb0, 0xb3}};
...
{
  return InitializePlatformReset (ImageHandle, SystemTable);
}
