...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x905CF1B3, 0x32F8, 0x489c, {0xA6, 0x41, 0x46, 0xA7, 0x14, 0x58, 0x32, 0x62}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AmiErrorLog";
...
{
  return InitializeAmiErrorLog (ImageHandle, SystemTable);
}
