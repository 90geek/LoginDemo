...
// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gIioVVarGuid = { 0xcccd2056, 0xd401, 0x4def, {0x85, 0xb0, 0x1f, 0xa1, 0x1f, 0xf3, 0xb5, 0xe3}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiWheaProcessorSpecificErrorSectionGuid = { 0xdc3ea0b0, 0xa144, 0x4797, { 0xb5, 0x5b, 0x53, 0xfa, 0x24, 0x2b, 0x6e, 0x1d }};
  ...
  )
{
  ...
  Status = EmcaPlatformHooksLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
