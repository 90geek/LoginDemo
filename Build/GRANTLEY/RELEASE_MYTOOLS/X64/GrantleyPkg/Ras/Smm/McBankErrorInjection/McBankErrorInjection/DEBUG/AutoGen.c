...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1B59CCDA, 0x7DB2, 0x4A55, {0xAF, 0xC2, 0x43, 0x64, 0xF8, 0x24, 0xD2, 0x88}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "McBankErrorInjection";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (McejSmmEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
