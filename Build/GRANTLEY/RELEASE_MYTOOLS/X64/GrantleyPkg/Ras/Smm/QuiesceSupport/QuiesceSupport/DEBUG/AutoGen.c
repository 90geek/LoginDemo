...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE954929C, 0x5BAC, 0x4494, {0xB9, 0x63, 0x3B, 0x23, 0xD4, 0xA1, 0x3A, 0xD2}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "QuiesceSupport";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiQuiesceProtocolGuid = { 0x20d6e759, 0x4c4a, 0x40c0, { 0x95, 0x33, 0x2b, 0xf0, 0x06, 0x68, 0x50, 0xfd }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (QuiesceSupportInitialization (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
