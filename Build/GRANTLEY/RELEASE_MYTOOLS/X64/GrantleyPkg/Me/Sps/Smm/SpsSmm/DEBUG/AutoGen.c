...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x921CD783, 0x3E22, 0x4579, {0xA7, 0x1F, 0x00, 0xD7, 0x41, 0x97, 0xFC, 0xC9}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpsSmm";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSpsSmmHmrfpoProtocolGuid = { 0x5EBEB554, 0xDF6F, 0x45B9, { 0xAD, 0xCC, 0xD6, 0x81, 0x8C, 0xE3, 0xBE, 0x3B }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (SpsSmmEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
