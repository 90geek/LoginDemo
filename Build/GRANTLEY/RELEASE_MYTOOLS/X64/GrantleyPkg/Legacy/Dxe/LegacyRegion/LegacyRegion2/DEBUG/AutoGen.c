...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAA7B4695, 0x00B4, 0x4468, {0xAD, 0x92, 0x99, 0x37, 0x0A, 0xC0, 0x31, 0xC5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "LegacyRegion2";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdCboDev = _PCD_VALUE_PcdCboDev;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdCboFunc = _PCD_VALUE_PcdCboFunc;
...
{
  return LegacyRegionInstall (ImageHandle, SystemTable);
}
