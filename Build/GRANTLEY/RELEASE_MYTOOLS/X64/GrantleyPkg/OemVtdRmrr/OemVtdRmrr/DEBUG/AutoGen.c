...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAE587172, 0xCC15, 0x48e1, {0x8B, 0xE1, 0x29, 0xDD, 0xF0, 0x5C, 0x6A, 0x1E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OemVtdRmrr";
...
{
  return InitializeOemVtdRmrr (ImageHandle, SystemTable);
}
