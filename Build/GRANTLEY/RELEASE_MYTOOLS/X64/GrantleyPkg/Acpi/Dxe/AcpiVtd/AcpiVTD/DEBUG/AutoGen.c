...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x64A11188, 0x5B86, 0x4f59, {0xA7, 0x02, 0x73, 0x36, 0x58, 0x96, 0xE6, 0x5E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AcpiVTD";
...
{
  return VtdTableEntryPoint (ImageHandle, SystemTable);
}
