...
//----------------------------------------------------------------------------
//<AMI_PHDR_END>
void CheckandDeactivateSoftkbd(); //EIP-140123
...
//<AMI_PHDR_START>
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// Procedure:   ESAInitFvHook
//
// Description:  Set OVERRIDE_ESAInitFvHook to 1, if OEM wants to override the ESAInitFvHook function from Board module.
//
// Input:   VOID
//
// Output:  VOID
...
//<AMI_PHDR_START>
//-------------------------------------------------------------------------------------------------------------------------------------------------
// Procedure:   SetMessageBoxProgressType
//
// Description:  Set OVERRIDE_SetMessageBoxProgressType to 1, if OEM wants to override the GetMessageBoxProgressType function from Board module.
